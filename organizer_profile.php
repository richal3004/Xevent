		...
		if(!empty($event_date))
		{
			if(!empty($ticket_price))
			{
				...
				if(!empty($discri))
				{
					...
					{
						$sql="INSERT INTO events(event_name,event_city,event_date,organizer,ticket_price,discri) 
						values ('$event_name','$event_city','$event_date','$organizer','$ticket_price','$discri')";
